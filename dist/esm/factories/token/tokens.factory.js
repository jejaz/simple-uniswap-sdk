...
var TokensFactory = /** @class */ (function () {
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 8:
                        ...
                        for (result in contractCallResults.results) {
                            if (result.includes("_".concat(UniswapVersion.v2))) {
                                ...
                                resultInfoV3 = contractCallResults.results[result.replace("_".concat(UniswapVersion.v2), "_".concat(UniswapVersion.v3))];
                                if (!format) {
                                    results.push({
    ...
    TokensFactory.prototype.buildAllowanceAndBalanceContractCallContext = function (ethereumAddress, tokenContractAddress, uniswapVersion) {
        var defaultCallContext = {
            reference: "".concat(tokenContractAddress, "_").concat(uniswapVersion),
