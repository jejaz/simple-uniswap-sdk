...
var UniswapRouterFactory = /** @class */ (function () {
                    ...
                    case 0:
                        ...
                        if (this._settings.uniswapVersions.includes(UniswapVersion.v2)) {
                            contractCallContext.push({
                                ...
                                contractAddress: uniswapContracts.v2.getPairAddress(this._settings.cloneUniswapContractDetails, this._ethersProvider.provider.network.chainId),
                        ...
                        if (this._settings.uniswapVersions.includes(UniswapVersion.v3)) {
                            contractCallContext.push({
                                ...
                                calls: [
                                    {
                                        reference: "".concat(this._fromToken.contractAddress, "-").concat(this._toToken.contractAddress, "-").concat(this._fromToken.symbol, "/").concat(this._toToken.symbol),
                                        methodName: 'getPool',
                                        methodParameters: [
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToErc20Output = function (tokenAmountInMax, tokenAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapTokensForExactTokens(hexlify(amountInMax), hexlify(amountOut), routeQuoteTradeContext.routePathArray, this._ethereumAddress, deadline);
            case UniswapVersion.v3:
                ...
                for (var i = 0; i < contractCallReturnContext.callsReturnContext.length; i++) {
                    ...
                    switch (tradePath) {
                        ...
                        case TradePath.erc20ToErc20:
                            ...
                            break;
                        default:
                            throw new UniswapError("".concat(tradePath, " not found"), ErrorCodes.tradePathIsNotSupported);
                    }
                }
            }
        }
        ...
        switch (uniswapVersion) {
            ...
            case UniswapVersion.v3:
                return {
                    ...
                    routeText: "".concat(this._fromToken.symbol, " > ").concat(this._toToken.symbol),
                    routePathArray: [
        ...
        switch (uniswapVersion) {
            ...
            case UniswapVersion.v3:
                return {
                    ...
                    routeText: "".concat(turnTokenIntoEthForResponse(this._fromToken, (_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency).symbol, " > ").concat(this._toToken.symbol),
                    routePathArray: [
                        this._fromToken.contractAddress,
                        this._toToken.contractAddress,
                    ],
    ...
    UniswapRouterFactory.prototype.buildRouteQuoteForErc20ToEth = function (amountToTrade, callReturnContext, routeContext, direction, uniswapVersion) {
        ...
        var data = direction === TradeDirection.input
            ? this.generateTradeDataErc20ToEthInput(amountToTrade, new BigNumber(expectedConvertQuoteOrTokenAmountInMaxWithSlippage), routeQuoteTradeContext, tradeExpires.toString())
        ...
        switch (uniswapVersion) {
            ...
            case UniswapVersion.v3:
                return {
                    ...
                    routeText: "".concat(this._fromToken.symbol, " > ").concat(turnTokenIntoEthForResponse(this._toToken, (_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency).symbol),
                    routePathArray: [
                        this._fromToken.contractAddress,
                        this._toToken.contractAddress,
                    ],
    ...
    UniswapRouterFactory.prototype.formatAmountToTrade = function (amountToTrade, direction) {
        switch (this.tradePath()) {
            ...
            default:
                throw new UniswapError("Internal trade path ".concat(this.tradePath(), " is not supported"), ErrorCodes.tradePathIsNotSupported);
        }
    };
    /**
     * Get the trade path
