...
var UniswapRouterFactory = /** @class */ (function () {
                ...
                for (var i = 0; i < contractCallReturnContext.callsReturnContext.length; i++) {
                    ...
                    switch (tradePath) {
                        ...
                        case trade_path_2.TradePath.erc20ToErc20:
                            ...
                            break;
                        default:
                            throw new uniswap_error_1.UniswapError("".concat(tradePath, " not found"), error_codes_1.ErrorCodes.tradePathIsNotSupported);
                    }
                }
            }
        }
        ...
        switch (uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return {
                    ...
                    routeText: "".concat(this._fromToken.symbol, " > ").concat((0, eth_1.turnTokenIntoEthForResponse)(this._toToken, (_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency).symbol),
                    routePathArray: [
                        this._fromToken.contractAddress,
                        this._toToken.contractAddress,
                    ],
    ...
    UniswapRouterFactory.prototype.formatAmountToTrade = function (amountToTrade, direction) {
        switch (this.tradePath()) {
            ...
            default:
                throw new uniswap_error_1.UniswapError("Internal trade path ".concat(this.tradePath(), " is not supported"), error_codes_1.ErrorCodes.tradePathIsNotSupported);
        }
    };
    /**
     * Get the trade path
    ...
    Object.defineProperty(UniswapRouterFactory.prototype, "mainCurrenciesPairsForFromToken", {
        get: function () {
            ...
            if (this._ethersProvider.provider.network.chainId === chain_id_1.ChainId.POLYGON || this._ethersProvider.provider.network.chainId === chain_id_1.ChainId.MUMBAI) {
