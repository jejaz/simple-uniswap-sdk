...
var EthersProvider = /** @class */ (function () {
    ...
    EthersProvider.prototype.getChainName = function (chainId) {
        ...
        if (!chainName) {
            throw new uniswap_error_1.UniswapError("Can not find chain name for ".concat(chainId, ". This lib only supports mainnet(1), ropsten(4), kovan(42), rinkeby(4) and g\u00F6rli(5)"), error_codes_1.ErrorCodes.canNotFindChainId);
        }
        return chainName;
    };
    /**
